...
public class HbaseUtils {
    ...
    static InputStream inputStream = HbaseUtils.class.getClassLoader().getResourceAsStream("conf/configuration.properties");
    ...
    public static JSONArray convertToJsonArray(String tablename, List<String> rowkeylist) {
        JSONArray jsonArray = new JSONArray();
        try {
            Table table = conn.getTable(TableName.valueOf(tablename));
